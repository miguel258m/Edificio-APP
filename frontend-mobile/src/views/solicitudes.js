...
export function renderSolicitudes(container) {
    ...
    <div class="page">
      ...
      <div style="background: linear-gradient(135deg, var(--primary), var(--secondary)); padding: 2rem 1rem; margin-bottom: 1rem;">
        <div class="container">
          <div class="flex justify-between items-center">
            <div>
              <h1 style="font-size: 1.5rem; font-weight: 700; color: white;">📋 Mis Solicitudes</h1>
              <p style="font-size: 0.875rem; opacity: 0.9; color: white;">${user.nombre}</p>
            </div>
      ...
      <nav class="bottom-nav">
        <a href="#" class="nav-item" onclick="window.navigateTo('/dashboard-residente'); return false;">
    ...
    async function loadAllSolicitudes(filter = 'todas') {
        try {
          ...
          <div class="card text-center" style="padding: 3rem;">
            ...
            <p style="color: var(--text-muted);">No tienes solicitudes</p>
          </div>
        `;
                return;
            }
